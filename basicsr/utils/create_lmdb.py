...
def create_lmdb_for_gopro():
    folder_path = '/mnt/P40_NFS/20_Research/10_公共数据集/40_DeBlur/GoPro/gro_train_lmdb/blur_crops'
    lmdb_path = '/mnt/P40_NFS/20_Research/10_公共数据集/40_DeBlur/GoPro/gro_train_lmdb/blur_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/mnt/P40_NFS/20_Research/10_公共数据集/40_DeBlur/GoPro/gro_train_lmdb/sharp_crops'
    lmdb_path = '/mnt/P40_NFS/20_Research/10_公共数据集/40_DeBlur/GoPro/gro_train_lmdb/sharp_crops.lmdb'
...
def create_lmdb_for_impove():
    folder_path = '/mnt/P40_NFS/20_Research/10_公共数据集/40_DeBlur/ALL/blur_lmdb'
    lmdb_path = '/mnt/P40_NFS/20_Research/10_公共数据集/40_DeBlur/ALL/blur_lmdb/blur_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/mnt/P40_NFS/20_Research/10_公共数据集/40_DeBlur/ALL/sharp_lmdb'
    lmdb_path = '/mnt/P40_NFS/20_Research/10_公共数据集/40_DeBlur/ALL/sharp_lmdb/sharp_crops.lmdb'
